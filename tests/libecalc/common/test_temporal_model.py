...
class TestTemporalExpression:
    def test_single_value_expression(self, expression_evaluator_factory):
    ...
    def test_single_value_expression_with_start_date_after_time_vector_start(self, expression_evaluator_factory):
        expression_evaluator = expression_evaluator_factory.from_time_vector(
            [
                datetime(2019, 1, 1),
                datetime(2020, 1, 1),
    ...
    def test_multiple_times(self, expression_evaluator_factory):
        expression_evaluator = expression_evaluator_factory.from_time_vector(
            [
                datetime(2019, 1, 1),
                datetime(2020, 1, 1),
    ...
    def test_multiple_times_with_references(self, expression_evaluator_factory):
        expression_evaluator = expression_evaluator_factory.from_time_vector(
