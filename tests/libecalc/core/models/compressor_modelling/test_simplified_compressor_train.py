...
def simplified_compressor_train_unknown_stages(variable_speed_compressor_chart_dto, compressor_stages):
    ...
    def create_simplified_train(chart: CompressorChartDTO) -> CompressorTrainSimplifiedUnknownStages:
...
def test_simplified_compressor_train_unknown_stages(
    simplified_compressor_train_unknown_stages, fluid_factory_rich, variable_speed_compressor_chart_dto
):
    compressor_train = simplified_compressor_train_unknown_stages(chart=variable_speed_compressor_chart_dto)
    compressor_train.set_evaluation_input(
...
def test_simplified_compressor_train_unknown_stages_with_constant_power_adjustment(
    ...
    compressor_train_energy_function = simplified_compressor_train_unknown_stages(
        chart=variable_speed_compressor_chart_dto
    )
...
def test_evaluate_compressor_simplified_valid_points(
    simplified_compressor_train_with_known_stages, compressor_stages, fluid_factory_medium
):
...
def test_calculate_compressor_work(
    ...
    compressor_train.set_evaluation_input(
        ...
        rate=mass_rates,
        suction_pressure=fluid_factory.mass_rate_to_standard_rate(mass_rates),
