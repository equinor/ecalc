...
export default function Version(): JSX.Element {
  ...
  return (
    <Layout
      title="Versions"
      description="eCalc Versions page listing all documented versions"
    >
          ...
          <table>
            <tbody>
              <tr>
                ...
                <td>
                  <Link to={latestVersion.path + '/' + 'about'}>
                    <DocumentationLabel />
                  </Link>
                </td>
                <td>
                  <Link to={latestVersion.path + '/changelog/latest'}>
                    <ReleaseNotesLabel />
                  </Link>
                </td>
              </tr>
            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td>
                    <Link to={currentVersion.path + '/' + 'about'}>
                      <DocumentationLabel />
                    </Link>
                  </td>
                  <td>
                    <Link to={currentVersion.path + '/changelog/latest'}>
                      <ReleaseNotesLabel />
                    </Link>
                  </td>
                </tr>
