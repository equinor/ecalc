...
:::info
This page is auto-generated from the eCalc Pydantic model. Last generated: 2026-03-20.
:::
...
Defines fluid models that can be referenced by inlet streams.
...
### EOS_MODEL {#fluid_models-eos_model}

Equation of state model. Supported models are SRK, PR, GERG_SRK, GERG_PR

<code>SRK &#124; PR &#124; GERG_SRK &#124; GERG_PR</code> · default: <code>SRK</code>

### FLUID_MODEL_TYPE {#fluid_models-fluid_model_type}

Defines the fluid model type.

Allowed values: `PREDEFINED` &#124; `COMPOSITION` · default: <code>PREDEFINED</code>

<div className="yaml-variant">

#### PREDEFINED {#fluid_models-predefined}
...
- **GAS_TYPE**<span id="fluid_models-predefined-gas_type"></span><br/>  Predefined gas type. Supported types are ULTRA_DRY, DRY, MEDIUM, RICH, ULTRA_RICH<br/>  Allowed values: <code>ULTRA_DRY &#124; DRY &#124; MEDIUM &#124; RICH &#124; ULTRA_RICH</code>

</div>

<div className="yaml-variant">

#### COMPOSITION {#fluid_models-composition}
...
- **COMPOSITION** *(required)*<span id="fluid_models-composition-composition"></span><br/>  Components in fluid and amount (relative to the others) in mole weights (<code>Composition</code>)
  - **CO2**<span id="fluid_models-composition-composition-co2"></span><br/>    Mole fraction of CO2 (<code>number</code> · default: <code>0.0</code>)

  - **ethane**<span id="fluid_models-composition-composition-ethane"></span><br/>    Mole fraction of ethane (<code>number</code> · default: <code>0.0</code>)

  - **i_butane**<span id="fluid_models-composition-composition-i_butane"></span><br/>    Mole fraction of i-butane (<code>number</code> · default: <code>0.0</code>)

  - **i_pentane**<span id="fluid_models-composition-composition-i_pentane"></span><br/>    Mole fraction of i-pentane (<code>number</code> · default: <code>0.0</code>)

  - **methane** *(required)*<span id="fluid_models-composition-composition-methane"></span><br/>    Mole fraction of methane (required) (<code>number</code>)

  - **n_butane**<span id="fluid_models-composition-composition-n_butane"></span><br/>    Mole fraction of n-butane (<code>number</code> · default: <code>0.0</code>)

  - **n_hexane**<span id="fluid_models-composition-composition-n_hexane"></span><br/>    Mole fraction of n-hexane (<code>number</code> · default: <code>0.0</code>)

  - **n_pentane**<span id="fluid_models-composition-composition-n_pentane"></span><br/>    Mole fraction of n-pentane (<code>number</code> · default: <code>0.0</code>)

  - **nitrogen**<span id="fluid_models-composition-composition-nitrogen"></span><br/>    Mole fraction of nitrogen (<code>number</code> · default: <code>0.0</code>)

  - **propane**<span id="fluid_models-composition-composition-propane"></span><br/>    Mole fraction of propane (<code>number</code> · default: <code>0.0</code>)

  - **water**<span id="fluid_models-composition-composition-water"></span><br/>    Mole fraction of water (<code>number</code> · default: <code>0.0</code>)


</div>

### NAME *(required)* {#fluid_models-name}

Name of the model. See documentation for more information. (<code>text</code>)

### TYPE {#fluid_models-type}

Defines the type of model.

<code>FLUID</code> · default: <code>FLUID</code>
...
### NAME *(required)* {#inlet_streams-name}

Unique name of the inlet stream. (<code>text</code>)

### FLUID_MODEL *(required)* {#inlet_streams-fluid_model}

Reference to a fluid model (e.g. defined in MODELS/FLUID_MODELS elsewhere). (<code>text ∣ PREDEFINED ∣ COMPOSITION</code>)

- **EOS_MODEL**<span id="inlet_streams-fluid_model-eos_model"></span><br/>  Equation of state model. Supported models are SRK, PR, GERG_SRK, GERG_PR<br/>  Allowed values: <code>SRK &#124; PR &#124; GERG_SRK &#124; GERG_PR</code> · default: <code>SRK</code>

- **FLUID_MODEL_TYPE**<span id="inlet_streams-fluid_model-fluid_model_type"></span><br/>  Defines the fluid model type. (default: <code>PREDEFINED</code>)
  - **PREDEFINED**<span id="inlet_streams-fluid_model-predefined"></span><br/>    *Fluid model using a predefined fluid type.*
    - **GAS_TYPE**<span id="inlet_streams-fluid_model-predefined-gas_type"></span><br/>      Predefined gas type. Supported types are ULTRA_DRY, DRY, MEDIUM, RICH, ULTRA_RICH<br/>      Allowed values: <code>ULTRA_DRY &#124; DRY &#124; MEDIUM &#124; RICH &#124; ULTRA_RICH</code>


  - **COMPOSITION**<span id="inlet_streams-fluid_model-composition"></span><br/>    *Fluid model defined by a custom composition.*
    - **COMPOSITION** *(required)*<span id="inlet_streams-fluid_model-composition-composition"></span><br/>      Components in fluid and amount (relative to the others) in mole weights (<code>Composition</code>)
      - **CO2**<span id="inlet_streams-fluid_model-composition-composition-co2"></span><br/>        Mole fraction of CO2 (<code>number</code> · default: <code>0.0</code>)

      - **ethane**<span id="inlet_streams-fluid_model-composition-composition-ethane"></span><br/>        Mole fraction of ethane (<code>number</code> · default: <code>0.0</code>)

      - **i_butane**<span id="inlet_streams-fluid_model-composition-composition-i_butane"></span><br/>        Mole fraction of i-butane (<code>number</code> · default: <code>0.0</code>)

      - **i_pentane**<span id="inlet_streams-fluid_model-composition-composition-i_pentane"></span><br/>        Mole fraction of i-pentane (<code>number</code> · default: <code>0.0</code>)

      - **methane** *(required)*<span id="inlet_streams-fluid_model-composition-composition-methane"></span><br/>        Mole fraction of methane (required) (<code>number</code>)

      - **n_butane**<span id="inlet_streams-fluid_model-composition-composition-n_butane"></span><br/>        Mole fraction of n-butane (<code>number</code> · default: <code>0.0</code>)

      - **n_hexane**<span id="inlet_streams-fluid_model-composition-composition-n_hexane"></span><br/>        Mole fraction of n-hexane (<code>number</code> · default: <code>0.0</code>)

      - **n_pentane**<span id="inlet_streams-fluid_model-composition-composition-n_pentane"></span><br/>        Mole fraction of n-pentane (<code>number</code> · default: <code>0.0</code>)

      - **nitrogen**<span id="inlet_streams-fluid_model-composition-composition-nitrogen"></span><br/>        Mole fraction of nitrogen (<code>number</code> · default: <code>0.0</code>)

      - **propane**<span id="inlet_streams-fluid_model-composition-composition-propane"></span><br/>        Mole fraction of propane (<code>number</code> · default: <code>0.0</code>)

      - **water**<span id="inlet_streams-fluid_model-composition-composition-water"></span><br/>        Mole fraction of water (<code>number</code> · default: <code>0.0</code>)




- **NAME** *(required)*<span id="inlet_streams-fluid_model-name"></span><br/>  Name of the model. See documentation for more information. (<code>text</code>)

- **TYPE**<span id="inlet_streams-fluid_model-type"></span><br/>  Defines the type of model. (<code>FLUID</code> · default: <code>FLUID</code>)

### TEMPERATURE {#inlet_streams-temperature}

Temperature in K. Optional; defaults to standard temperature if omitted. (<code>text ∣ number ∣ integer</code>)

### PRESSURE {#inlet_streams-pressure}

Pressure in Pa. Optional; defaults to standard pressure if omitted. (<code>text ∣ number ∣ integer</code>)

### RATE *(required)* {#inlet_streams-rate}

Rate with unit + value. (<code>Rate</code>)

- **UNIT** *(required)*<span id="inlet_streams-rate-unit"></span><br/>  Rate unit. SM3_PER_DAY for standard volume, KG_PER_HOUR for mass, KMOL_PER_HOUR for molar rate.<br/>  Allowed values: <code>SM3_PER_DAY &#124; KG_PER_HOUR</code>

- **CONDITION**<span id="inlet_streams-rate-condition"></span><br/>  A logical condition that determines whether the venting emitter emission rate is applicable. This condition must evaluate to true for the rate to be used.

For more details, see:<br/>  Allowed values: <code>text ∣ number ∣ integer</code>

- **CONDITIONS**<span id="inlet_streams-rate-conditions"></span><br/>  A list of logical conditions that collectively determine whether the venting emitter emission rate is applicable. All conditions in the list must evaluate to true for the rate to be used.
...
<code>dict[text, Compressor]</code>

Defines process units used in PROCESS_SYSTEMS.
...
### NAME *(required)* {#process_units-name}
...
Defines process systems to use in process simulations.
...
### TYPE *(required)* {#process_systems-type}

Process system type

Allowed values: `SERIAL` &#124; `COMPRESSOR_STAGE`

<div className="yaml-variant">

#### SERIAL {#process_systems-serial}
...
- **ITEMS** *(required)*<span id="process_systems-serial-items"></span><br/>  List of process stages in series

</div>

<div className="yaml-variant">

#### COMPRESSOR_STAGE {#process_systems-compressor_stage}
...
- **INLET_TEMPERATURE** *(required)*<span id="process_systems-compressor_stage-inlet_temperature"></span><br/>  Inlet temperature in Celsius for stage<br/>  Allowed values: <code>text ∣ number ∣ integer</code>

- **PRESSURE_DROP_AHEAD_OF_STAGE**<span id="process_systems-compressor_stage-pressure_drop_ahead_of_stage"></span><br/>  Pressure drop before compression stage [in bar]<br/>  Allowed values: <code>text ∣ number ∣ integer</code> · default: <code>0.0</code>

</div>

### NAME *(required)* {#process_systems-name}

Name of the process system (<code>text</code>)
...
### TARGETS *(required)* {#process_simulations-targets}

### CONSTRAINTS {#process_simulations-constraints}

Optional constraints per process system reference.

- **OUTLET_PRESSURE**<span id="process_simulations-constraints-outlet_pressure"></span><br/>  Target outlet pressure [bara].<br/>  Allowed values: <code>text ∣ number ∣ integer</code>
