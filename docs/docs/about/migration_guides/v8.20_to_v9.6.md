...
## v8.20 to v8.21 {/* #v820-to-v821 */}

### 1. Changes to EFFICIENCY {/* #1-changes-to-efficiency */}
...
### 2. Changes to PRESSURE_DROP_AHEAD_OF_STAGE {/* #2-changes-to-pressure_drop_ahead_of_stage */}

`PRESSURE_DROP_AHEAD_OF_STAGE` for Simplified Variable Speed Train has no effect and is now treated as an error.

## v8.22 to v8.23 {/* #v822-to-v823 */}

### 1. Changes to COMPOSITION {/* #1-changes-to-composition */}
...
## v8.26 to v9.0 {/* #v826-to-v90 */}

### Changes to compressor trains in MODELS {/* #changes-to-compressor-trains-in-models */}
...
### Changes to simplified compressor trains in MODELS {/* #changes-to-simplified-compressor-trains-in-models */}
...
## v9.0 to v9.6 {/* #v90-to-v96 */}

### Important Control Margin changes for compressors {/* #important-control-margin-changes-for-compressors */}
...
### Enforcing more unique names {/* #enforcing-more-unique-names */}
