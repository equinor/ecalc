...
### Operational settings used is now 1-based {/* #operational-settings-used-is-now-1-based */}
...
### Resampling of rates changed from forward filling to average rates {/* #resampling-of-rates-changed-from-forward-filling-to-average-rates */}
