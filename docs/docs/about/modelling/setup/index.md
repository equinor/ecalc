...
First some general information about [File formats and syntax](/about/modelling/setup/file_formats_and_syntax/index.md),
with some specific details about writing [Expressions](/about/modelling/setup/file_formats_and_syntax/expressions.md)
in the YAML file.
