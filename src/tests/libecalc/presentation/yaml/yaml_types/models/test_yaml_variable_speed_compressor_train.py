...
def test_control_margin_required():
    ...
    assert (
        f"MODELS[2].{EcalcYamlKeywords.models_type_compressor_train_variable_speed}.COMPRESSOR_TRAIN.STAGES[0].{EcalcYamlKeywords.models_type_compressor_train_stage_control_margin}"
        in str(errors[0])
    )
    ...
    assert (
        f"MODELS[2].{EcalcYamlKeywords.models_type_compressor_train_variable_speed}.COMPRESSOR_TRAIN.STAGES[0].{EcalcYamlKeywords.models_type_compressor_train_stage_control_margin_unit}"
        in str(errors[1])
    )
