...
def test_full_3d_compressor():
    ...
    res = energy_func.evaluate_rate_ps_pd(
        rate=rate,
...
def test_full_3d_compressor_degenerated_ps():
    data = pd.DataFrame(
        [
...
def test_full_3d_compressor_degenerated_rate():
    data = pd.DataFrame(
        [
            [1000000, 50, 162, 52765],
            [1000000, 50, 258, 76928],
...
def test_full_3d_compressor_degenerated_pd():
    data = pd.DataFrame(
        [
            [1000000, 50, 300, 6.0],
            [3000000, 50, 300, 18.0],
...
def test_full_3d_compressor_degenerated_rate_ps():
    data = pd.DataFrame(
...
def test_2d_compressor_degenerated_ps():
    df_2d = pd.DataFrame(
        [
            [1000000, 162, 52765],
            [1000000, 258, 76928],
...
def test_2d_compressor_degenerated_rate():
    df_2d = pd.DataFrame(
        [
            [50, 162, 52765],
            [50, 258, 76928],
...
def test_1d_compressor_rate():
    ...
    res = energy_func.evaluate_rate_ps_pd(rate=rate, suction_pressure=None, discharge_pressure=None).energy_usage
    np.testing.assert_allclose(res, expected)
...
def test_1d_compressor_pd():
    ...
    np.testing.assert_allclose(res, expected)
    res = energy_func.evaluate_rate_ps_pd(rate=None, suction_pressure=None, discharge_pressure=pr_d).energy_usage
    np.testing.assert_allclose(res, expected)

    res = energy_func.evaluate_rate_ps_pd(rate=None, suction_pressure=pr_d, discharge_pressure=pr_d).energy_usage
    np.testing.assert_allclose(res, expected)
