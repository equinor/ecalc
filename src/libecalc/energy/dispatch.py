...
class DispatchStrategy(abc.ABC):
    ...
    @abc.abstractmethod
    def get_candidate_ids(self) -> frozenset[EnergyUnitId]: ...
...
class PriorityDispatch(DispatchStrategy):
    ...
    def allocate(
        ...
        allocations: dict[EnergyUnitId, Energy] = {candidate.candidate_id: nothing for candidate in candidates}
        remaining = demand
