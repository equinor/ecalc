...
class CompressorTrainCommonShaftFailureStatus(str, Enum):
    ...
    TARGET_INTERMIEDIATE_PRESSURE_TOO_HIGH = "TARGET_INTERMIEDIATE_PRESSURE_TOO_HIGH"
    TARGET_INTERMIEDIATE_PRESSURE_TOO_LOW = "TARGET_INTERMIEDIATE_PRESSURE_TOO_LOW"
