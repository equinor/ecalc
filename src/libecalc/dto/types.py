...
class PumpFlag(str, Enum):
    NEGATIVE_RATE = "NEGATIVE_RATE"
    NOT_CALCULATED = "NOT_CALCULATED"
    INTERNAL_POINT = "INTERNAL_POINT"
    RESIRC_LESS_THAN_MINIMUM_RATE = "RESIRC_LESS_THAN_MINIMUM_RATE"
    INVALID_ABOVE_MAXIMUM_PUMP_RATE = "INVALID_ABOVE_MAXIMUM_PUMP_RATE"
    INVALID_REQUIRED_HEAD_ABOVE_ACTUAL_HEAD = "INVALID_REQUIRED_HEAD_ABOVE_ACTUAL_HEAD"
