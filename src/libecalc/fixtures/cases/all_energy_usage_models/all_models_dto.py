...
def compressor_system_variable_speed_compressor_trains(
    ...
    return FuelConsumer(
        ...
        energy_usage_model={
            ...
            Period(datetime(2019, 1, 1)): CompressorSystemConsumerFunction(
                energy_usage_type=EnergyUsageType.FUEL,
...
def simplified_compressor_train_predefined_variable_speed_charts_with_gerg_fluid(
    ...
    return ElectricityConsumer(
        ...
        regularity=regularity,
        energy_usage_model={
            Period(datetime(1900, 1, 1)): CompressorConsumerFunction(
...
def pump_system_el_consumer(single_speed_pump, regularity) -> ElectricityConsumer:
    return ElectricityConsumer(
        ...
        regularity=regularity,
        energy_usage_model={
            Period(datetime(1900, 1, 1)): PumpSystemConsumerFunction(
...
def simplified_variable_speed_compressor_train_known_stages_consumer_temporal_model(
    ...
    return ElectricityConsumer(
        ...
        energy_usage_model={
            ...
            Period(datetime(2019, 1, 1)): CompressorConsumerFunction(
                energy_usage_type=EnergyUsageType.POWER,
                rate_standard_m3_day=Expression.setup_from_expression(value=5000000),
...
def compressor_system(fuel_gas, compressor_sampled_1d, regularity) -> FuelConsumer:
    return FuelConsumer(
        ...
        fuel=fuel_gas,
        energy_usage_model={
            Period(datetime(1900, 1, 1)): CompressorSystemConsumerFunction(
                power_loss_factor=Expression.setup_from_expression(value=0.05),
                energy_usage_type=EnergyUsageType.FUEL,
                compressors=[
                    CompressorSystemCompressor(
...
def late_start_consumer(regularity) -> ElectricityConsumer:
    return ElectricityConsumer(
        ...
        energy_usage_model={
            ...
            Period(datetime(2020, 1, 1)): DirectConsumerFunction(
...
def late_start_consumer_evolving_type(regularity) -> ElectricityConsumer:
    return ElectricityConsumer(
        ...
        regularity=regularity,
        energy_usage_model={
            Period(datetime(2018, 1, 1)): TabulatedConsumerFunction(
                model=TabulatedData(
                    headers=["RATE", "POWER"],
                    data=[
...
def salt_water_injection_tabular(regularity) -> ElectricityConsumer:
    return ElectricityConsumer(
        ...
        regularity=regularity,
        energy_usage_model={
            Period(datetime(1900, 1, 1)): TabulatedConsumerFunction(
                model=TabulatedData(
                    headers=["RATE", "POWER"],
                    data=[
                        [0, 1, 8500, 9000, 17000, 17500, 36000, 72000, 142000],
...
def water_injection_single_speed(regularity, single_speed_pump) -> ElectricityConsumer:
    return ElectricityConsumer(
        ...
        regularity=regularity,
        energy_usage_model={
            Period(datetime(1900, 1, 1)): PumpConsumerFunction(
...
def flare(fuel_gas, regularity) -> FuelConsumer:
    return FuelConsumer(
        ...
        user_defined_category={Period(datetime(1900, 1, 1)): ConsumerUserDefinedCategoryType.FLARE},
        regularity=regularity,
    )
        ...
        Asset(
            ...
            installations=[
                Installation(
                    ...
                    regularity=regularity,
                    hydrocarbon_export={
                        Period(datetime(1900, 1, 1)): Expression.setup_from_expression(
                    ...
                    fuel_consumers=[
                        GeneratorSet(
                            ...
                            generator_set_model={
                                ...
                                Period(datetime(2018, 1, 1)): genset_sampled,
                            },
                            regularity=regularity,
                            fuel=fuel_gas,
                            consumers=[
