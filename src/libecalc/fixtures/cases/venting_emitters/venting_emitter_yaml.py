...
{textwrap.indent(create_fuel_consumers(include_fuel_consumers=include_fuel_consumers), prefix='  ')}
{textwrap.indent(create_venting_emitters_yaml(
...
INSTALLATIONS:
    {''.join(textwrap.indent(installation_factory(), prefix='  ') for installation_factory in installation_factories)}
        """
      ...
      FUELCONSUMERS:
        - NAME: Fuel consumer 1
          ...
          ENERGY_USAGE_MODEL:
            ...
            FUELRATE: 10
"""
    return textwrap.dedent(fuel_consumers)
...
def create_venting_emitters_yaml(
    ...
    return textwrap.dedent(emitters)
