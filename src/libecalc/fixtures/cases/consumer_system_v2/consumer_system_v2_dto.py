...
regularity = {
    Period(datetime(2022, 1, 1, 0, 0)): Expression.setup_from_expression(1),
}
fuel = {
    Period(datetime(2022, 1, 1, 0, 0)): FuelType(
        name="fuel_gas",
...
compressor1 = CompressorComponent(
    name="compressor1",
    user_defined_category={Period(datetime(2022, 1, 1)): ConsumerUserDefinedCategoryType.COMPRESSOR},
    fuel=fuel,
    regularity=regularity,
    consumes=ConsumptionType.FUEL,
    energy_usage_model={Period(datetime(2022, 1, 1, 0, 0)): compressor_1d},
)
...
compressor3 = CompressorComponent(
    ...
    regularity=regularity,
    consumes=ConsumptionType.FUEL,
    energy_usage_model={Period(datetime(2022, 1, 1)): compressor_1d},
)
compressor4_temporal_model = CompressorComponent(
    ...
    consumes=ConsumptionType.FUEL,
    energy_usage_model={
        Period(datetime(2022, 1, 1, 0, 0), datetime(2024, 1, 1, 0, 0)): compressor_1d,
        Period(datetime(2024, 1, 1, 0, 0)): compressor_1d,
    },
)
compressor5_with_overlapping_temporal_model = CompressorComponent(
    ...
    energy_usage_model={
        Period(datetime(2022, 1, 1, 0, 0), datetime(2024, 1, 1, 0, 0)): compressor_1d,
        Period(datetime(2024, 1, 1, 0, 0), datetime(2025, 1, 1, 0, 0)): compressor_1d,
        Period(datetime(2025, 1, 1, 0, 0)): compressor_1d,
    },
)

pump1 = PumpComponent(
    name="pump1",
    user_defined_category={Period(datetime(2022, 1, 1)): ConsumerUserDefinedCategoryType.PUMP},
    regularity=regularity,
    consumes=ConsumptionType.ELECTRICITY,
    energy_usage_model={Period(datetime(2022, 1, 1)): pump_model_single_speed},
)
pump2 = PumpComponent(
    name="pump2",
    user_defined_category={Period(datetime(2022, 1, 1)): ConsumerUserDefinedCategoryType.PUMP},
...
compressor_system = FuelConsumer(
    ...
    fuel=fuel,
    energy_usage_model={
        Period(datetime(2022, 1, 1)): CompressorSystemConsumerFunction(
            energy_usage_type=EnergyUsageType.FUEL,
...
pump_system = ElectricityConsumer(
    ...
    name="pump_system",
    energy_usage_model={
        Period(datetime(2022, 1, 1)): PumpSystemConsumerFunction(
        ...
        Asset(
            ...
            installations=[
                Installation(
                    ...
                    regularity=regularity,
                    hydrocarbon_export={Period(datetime(2022, 1, 1)): Expression.setup_from_expression(17)},
                    fuel_consumers=[
                        GeneratorSet(
                            name="GeneratorSet",
                            user_defined_category={
                                Period(datetime(2022, 1, 1)): ConsumerUserDefinedCategoryType.TURBINE_GENERATOR
                            },
                            generator_set_model={
                                Period(datetime(2022, 1, 1)): genset,
                            },
                            regularity=regularity,
                            fuel=fuel,
