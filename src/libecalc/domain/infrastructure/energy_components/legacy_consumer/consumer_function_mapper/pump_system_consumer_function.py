...
from libecalc.domain.process.dto.consumer_system import PumpSystemConsumerFunction as PumpSystemConsumerFunctionDTO
from libecalc.domain.process.dto.consumer_system import PumpSystemOperationalSetting
from libecalc.domain.process.pump.factory import create_pump_model
from libecalc.expression import Expression

from .compressor_system_consumer_function import map_discharge_pressures, map_rates, map_suction_pressures
    ...
    return PumpSystemConsumerFunction(
        ...
        operational_settings_expressions=[
            _map_operational_setting(
                ...
                system_fluid_density=model_dto.fluid_density,  # type: ignore[arg-type]
