...
class Mixer:
    def __init__(self, number_of_inputs: int, mixing_strategy: StreamMixingStrategy = SimplifiedStreamMixing()):
        self._number_of_inputs = number_of_inputs
        self._mixing_strategy = mixing_strategy
    ...
    @property
    def mixing_strategy(self) -> StreamMixingStrategy:
        return self._mixing_strategy
