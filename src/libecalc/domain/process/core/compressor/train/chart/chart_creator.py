...
from libecalc.domain.process.core.compressor.train.chart.generic_chart_data import (
...
from libecalc.domain.process.core.compressor.train.chart.types import CompressorChartResult
