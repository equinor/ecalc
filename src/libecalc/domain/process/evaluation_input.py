...
class ConsumerSystemOperationalInput:
    def __init__(
        self,
        actual_operational_settings: dict[int, dict[str, list[float]]],
        crossover_used: list[bool],
        operational_setting_number_used_per_timestep: NDArray[np.int_],
        periods: Periods,
    ):
        self._actual_operational_settings = actual_operational_settings
        self._crossover_used = crossover_used
        self._operational_settings_number_used_per_timestep = operational_setting_number_used_per_timestep
        self._periods = periods

    @property
    def actual_operational_settings(self) -> dict[int, dict[str, list[float]]]:
        return self._actual_operational_settings

    @property
    def crossover_used(self) -> list[bool]:
        return self._crossover_used

    @property
    def operational_setting_number_used_per_timestep(self) -> NDArray[np.int_]:
        return self._operational_settings_number_used_per_timestep
