...
class StrictExpressionEvaluator(ExpressionEvaluator):
    ...
    def from_expression_references(
        ...
        time_series_configs: list[YamlTimeSeriesCollection],
        time_series_resources: dict[str, TimeSeriesResource],
        start: datetime | None,
        end: datetime,
    ) -> Self:
        ...
        if var_names:
            ...
            all_refs = expression_references | var_refs
        else:
        ...
        time_series_file_to_name_map = {
            time_series_config.file: time_series_config.name for time_series_config in time_series_configs
        }
        time_series_resources_used = {
            time_series_file_to_name_map[tsr_file_name]: tsr
            for tsr_file_name, tsr in time_series_resources.items()
            if time_series_file_to_name_map[tsr_file_name] in expression_references_map
        }
