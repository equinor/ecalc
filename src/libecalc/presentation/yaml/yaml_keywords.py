...
class EcalcYamlKeywords:
    ...
    installation_direct_emitters = "DIRECT_EMITTERS"
    installation_direct_emitter_emission_name = "EMISSION_NAME"
    installation_direct_emitter_emission_rate = "EMISSION_RATE"
    installation_direct_emitter_model = "EMITTER_MODEL"
