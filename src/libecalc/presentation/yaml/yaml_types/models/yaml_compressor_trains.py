...
class YamlSingleSpeedCompressorTrain(YamlCompressorTrainBase):
    ...
    power_adjustment_constant: float = Field(
        0.0,
        description="[DEPRECATED] Constant to adjust power usage in MW. Use MECHANICAL_EFFICIENCY instead.",
        title="POWER_ADJUSTMENT_CONSTANT",
    )
    power_adjustment_factor: float = Field(
        1.0,
        description="[DEPRECATED] Factor to adjust power usage in MW. Use MECHANICAL_EFFICIENCY instead.",
    ...
    mechanical_efficiency: float = Field(
        1.0,
        description="Mechanical efficiency of the compressor train shaft. "
    ...
    def validate_mechanical_efficiency_and_legacy_params(self):
        """Validate mutual exclusivity of MECHANICAL_EFFICIENCY and legacy power adjustment parameters."""
        ...
        if has_mechanical_efficiency and (has_legacy_factor or has_legacy_constant):
            raise ValueError(
                f"Model '{self.name}': Cannot specify both MECHANICAL_EFFICIENCY and POWER_ADJUSTMENT_FACTOR/POWER_ADJUSTMENT_CONSTANT. "
                "Use MECHANICAL_EFFICIENCY instead of legacy power adjustment parameters."
            )
        ...
        if has_legacy_factor or has_legacy_constant:
            logger.warning(
                ...
                "and will be removed in a future version. Use MECHANICAL_EFFICIENCY instead. "
                "See migration guide: https://equinor.github.io/ecalc/about/migration_guides/mechanical_efficiency"
            )
