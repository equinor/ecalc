...
class YamlSingleSpeedChart(YamlBase):
    ...
    type: Annotated[
        Literal[YamlModelType.COMPRESSOR_CHART],
        Field(
    ...
    curve: Annotated[
        DataOrFile[YamlCurve],
        Field(description="One single compressor chart curve.", title="CURVE"),
    ]
...
class YamlGenericFromInputChart(YamlBase):
    ...
    polytropic_efficiency: Annotated[
        float,
        Field(
...
class YamlGenericFromDesignPointChart(YamlBase):
    ...
    design_rate: Annotated[
        float,
        Field(ge=0, description="Design rate for generic compressor chart", title="DESIGN_RATE"),
    ]
    design_head: Annotated[
        float,
        Field(ge=0, description="Design head for generic compressor chart", title="DESIGN_HEAD"),
    ]
    units: YamlUnits
