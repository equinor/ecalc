...
class YamlInterstageControlPressure(YamlBase):
    upstream_pressure_control: Annotated[
        YamlPressureControl,
        Field(
    ...
    downstream_pressure_control: Annotated[
        YamlPressureControl,
        Field(
            description="Pressure control.",
...
class YamlCompressorStageMultipleStreams(YamlCompressorStageWithMarginAndPressureDrop):
    ...
    interstage_control_pressure: Annotated[
        YamlInterstageControlPressure | None,
        Field(
...
class YamlUnknownCompressorStages(YamlBase):
    maximum_pressure_ratio_per_stage: Annotated[
        float | None,
        Field(
